...
Follow this [tutorial](https://github.com/moptis/era5-for-wrf/blob/main/tutorials/era5_global_timeseries.ipynb). In summary you want to find the gid (1 to 1038240) that matches with the latitude/longitude pair that you are interested in and then use this code:
...
Having spent the blog post raving about ERA5 you'll be surprised to hear that their sibling has been planed and will have some major improvements:
...
... but it's not due until 2027. So there's still life in ERA5 for some time yet, however there are a few changes for one of the sources.
